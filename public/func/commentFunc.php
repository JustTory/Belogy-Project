<?php
    function getCommentList($conn, $postID) {
        $sql = "SELECT DISTINCT c.cmt_ID, c.cmt_content, c.cmt_author_ID, u.user_username, u.user_id, c.cmt_date_created FROM comments c, users u, posts p WHERE c.cmt_author_ID = u.user_ID and c.cmt_post_ID = ? ORDER BY c.cmt_ID DESC";
